...
class SaveLogger:
    ...
    def save(self,epoch,opt,WindowModel,ChromeModel,valid_loss,valid_metrics_sum,valid_metrics_sums,valid_preds,valid_targs,test_preds=None,test_targs=None):
